...
import { GradientBarChart, GradientBarChart2, LineChart } from './ecommercedata/barcharts'
import AOS from 'aos';
                ...
                <Card.Body>
                  <div className="d-flex">
                    <div>
                      ...
                      <h3 className="mt-1 mb-1 text-dark fw-semibold">20.88 %</h3>
                ...
                <Card.Body>
                  <div className="d-flex">
                    <div>
                      ...
                      <h3 className="mt-1 mb-1 text-dark fw-semibold">1,99,011</h3>
                      {/* <div className="text-muted fs-12 mt-2"><i className="fa fa-signal text-success me-1"></i>
