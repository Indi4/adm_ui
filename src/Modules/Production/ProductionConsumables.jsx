...
const ProductionConsumables = ({ month, data }) => {
    ...
    <Container>
      {isLoading ? (
        ...
        <Card style={{ border: "none", padding: "5px", borderRadius: "10px" }}>
          <CardTitle style={{ fontSize: "14px", fontWeight: "bold" ,color:"black"}}>Production Consumables</CardTitle>
          <ResponsiveContainer width="100%" height={250}>
            <ComposedChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              ...
              <Tooltip />
              <Legend />
              <Line dataKey="target" stroke="#008CFF" strokeWidth={2} name="Target" dot={{ r: 3 }} />
              <Line dataKey="actual" stroke="#FF5733" strokeWidth={2} name="Actual" dot={{ r: 3 }} />
{/*               
...
export default ProductionConsumables;
